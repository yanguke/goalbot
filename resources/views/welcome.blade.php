...
<head>
    ...
    {{-- Primary SEO --}}
    <title>GoalBot — The smartest way to follow World Cup 2026 ⚽</title>
    <meta name="description" content="Your AI Insider for World Cup 2026. Get the story behind every goal, card, and match moment on WhatsApp. From KES 49/day.">
    ...
    <meta property="og:title" content="The smartest way to follow World Cup 2026 — Your AI Insider ⚽">
    ...
    <meta name="twitter:title" content="The smartest way to follow World Cup 2026 ⚽">
    ...
    <div class="container">
        ...
        <section class="hero">
            <div class="hero-content">
                <h1>The smartest way to follow World Cup 2026.</h1>
                <p class="subtitle">Your AI Insider — get the story behind every goal, card, and match moment. Delivered to your <strong>WhatsApp</strong>. ⚽</p>
                ...
                <form id="leadForm" class="lead-form" method="POST" action="/lead-capture">
                    ...
                    @foreach(['utm_source', 'utm_medium', 'utm_campaign', 'utm_term', 'utm_content', 'fbclid'] as $param)
                        @if(request($param))
